...
<body>
  ...
  <thead>
    <tr>
      <th class="service-code">Product Code</th>
      <th class="service-name">Product Name</th>
    </tr>
  </thead>
  <tbody>
  <c:forEach var="product" items="${productList}">
      <tr>
        <td class="service-code">${product.productCode}</td>
        <td class="service-name">${product.productName}</td>
      </tr>
  </c:forEach>
  </tbody>
</table>
